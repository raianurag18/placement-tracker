                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex gap-2">
                                <Input
                                    ...
                                    className="bg-white border-slate-200 text-slate-500 file:bg-slate-100 file:text-slate-700 file:border-0 file:rounded-md file:mr-4 file:px-4 file:py-2 hover:file:bg-slate-100"
                                />
